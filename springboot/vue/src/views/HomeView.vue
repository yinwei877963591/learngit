    ...
    <el-container>
      ...
      <el-header style="font-size: 12px; border-bottom: 1px solid #ccc; line-height: 60px; display: flex">
        <div style="flex: 1; font-size: 18px">
          <span :class="collapseBinClass" style="cursor: pointer" @click="collapse"></span>
        </div>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      collapseBinClass: 'el-icon-s-fold',
      isCollapse: false,
      sideWidth:200,
      logTextShow:true,
      headerBg: 'headerBg'
  ...
  methods: {
    collapse() {//点击收缩按钮触发
      ...
      if (this.isCollapse) {//收缩
        this.sideWidth = 64
        this.collapseBinClass = "el-icon-s-unfold"
        this.logTextShow = false
      }else {//展开
        this.sideWidth = 200
        this.collapseBinClass = 'el-icon-s-fold'
